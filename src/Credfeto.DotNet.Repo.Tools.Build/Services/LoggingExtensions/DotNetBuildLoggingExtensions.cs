...
internal static partial class DotNetBuildLoggingExtensions
{
    ...
    [LoggerMessage(
        ...
        Message = "Found framework {framework}"
    )]
    public static partial void LogFoundFramework(
        this ILogger<DotNetBuild> logger,
        string framework
    );
    ...
    [LoggerMessage(
        EventId = 4,
        Level = LogLevel.Information,
        Message = "Publishing for {framework}"
    )]
    public static partial void LogPublishingWithFramework(
        this ILogger<DotNetBuild> logger,
        string framework
    );
