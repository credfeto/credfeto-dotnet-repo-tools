...
public sealed class BulkTemplateUpdater : IBulkTemplateUpdater
{
    ...
    private static IEnumerable<CopyInstruction> GetStandardFilesToUpdate(in FileContext fileContext)
    {
        ...
        copyInstructions.AddRange(GetGitHubFilesToUpdate(fileContext: fileContext, templateConfig: templateConfig));
    ...
    private static IEnumerable<CopyInstruction> GetGitHubFilesToUpdate(
    ...
    )
    {
        ...
        copyInstructions.AddRange(
            GetIssueAndPullRequestTemplateFiles(fileContext: fileContext, templateConfig: templateConfig)
        );
        copyInstructions.AddRange(GetActionsAndLinterFiles(fileContext: fileContext, templateConfig: templateConfig));
    ...
    private static IEnumerable<CopyInstruction> GetIssueAndPullRequestTemplateFiles(
        in FileContext fileContext,
        TemplateConfig templateConfig
    )
    {
    ...
    private static IEnumerable<CopyInstruction> GetActionsAndLinterFiles(
        in FileContext fileContext,
        TemplateConfig templateConfig
    )
    {
    ...
    )
    {
        ...
        bool changed = await HaveLabelFilesChangedAsync(
            labelsFileName: labelsFileName,
            labelersFileName: labelersFileName,
            labels: labels,
            labeler: labeler,
            cancellationToken: cancellationToken
        );
        ...
        await WriteLabelFilesAndCommitAsync(
            repoContext: repoContext,
            labelsFileName: labelsFileName,
            labelersFileName: labelersFileName,
            labels: labels,
    ...
    private static async ValueTask<bool> HaveLabelFilesChangedAsync(
        string labelsFileName,
        string labelersFileName,
        string labels,
        string labeler,
        CancellationToken cancellationToken
    )
    {
        if (
            await HasFileContentChangedAsync(
        ...
        return await HasFileContentChangedAsync(
    ...
    private static async ValueTask WriteLabelFilesAndCommitAsync(
        RepoContext repoContext,
        string labelsFileName,
        string labelersFileName,
        string labels,
