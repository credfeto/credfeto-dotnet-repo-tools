...
{
    // Keep entries sorted by Name (case-insensitive, ordinal) when adding new labels.
    ...
    [
        ...
        new(Name: "Blocked", Description: "Blocked by a dependency or external factor", Colour: "ff0000", [], []),
        ...
        new(Name: "Editorconfig", Description: "Editor config file change", Colour: "00dead", [".editorconfig"], []),
        ...
        new(Name: "Refactor", Description: "Code refactoring", Colour: "30027a", [], []),
        new(
            Name: "Security",
    ...
    {
        IReadOnlyList<LabelConfig> sorted =
        [
            .. labels.OrderBy(keySelector: x => x.Name, comparer: StringComparer.OrdinalIgnoreCase),
        ];
        ...
        StringBuilder labelsWithColour = new StringBuilder()
        ...
        {
            labelsWithColour = WithBlankLine(labelsWithColour, ref firstLabel);
    ...
    private static StringBuilder WithBlankLine(StringBuilder builder, ref bool first)
    {
        if (!first)
        {
