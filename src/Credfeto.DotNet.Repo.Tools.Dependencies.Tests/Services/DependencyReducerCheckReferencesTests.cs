...
public sealed class DependencyReducerCheckReferencesTests : LoggingFolderCleanupTestBase
{
    ...
    public async Task CheckReferencesAsyncShouldRestoreSdkWhenMinimalSdkProjectBuildFailsAsync()
    {
        ...
        int projectBuildCallCount = 0;
        this._dotNetBuild.When(async b =>
                await b.BuildAsync(Arg.Any<string>(), Arg.Any<BuildContext>(), Arg.Any<CancellationToken>())
            )
            .Do(_ =>
            {
                ++projectBuildCallCount;
                if (projectBuildCallCount == 2)
                {
                    throw new DotNetBuildErrorException("Build failed with minimal SDK");
                }
            });
    ...
    public async Task CheckReferencesAsyncShouldThrowWhenFinalBuildFailsAsync()
    {
        ...
        this._dotNetBuild.When(async b =>
            ...
            .Do(_ =>
            {
                ...
                if (projectBuildCallCount >= 2)
                {
                    throw new DotNetBuildErrorException("Final build failed");
                }
            });
    ...
    public async Task CheckReferencesAsyncWithNonFunFairPackageRemovalBuildFailureShouldReturnFalseAsync()
    {
        ...
        this._dotNetBuild.When(async b =>
            ...
            .Do(_ =>
            {
                ...
                if (projectBuildCallCount == 2)
                {
                    throw new DotNetBuildErrorException("Package removal build failed");
                }
            });
    ...
    public async Task CheckReferencesAsyncWithProjectReferenceRemovalBuildFailureShouldRestoreAsync()
    {
        ...
        this._dotNetBuild.When(async b =>
            ...
            .Do(_ =>
            {
                ...
                if (projectBuildCallCount == 2)
                {
                    throw new DotNetBuildErrorException("Project ref removal build failed");
                }
            });
