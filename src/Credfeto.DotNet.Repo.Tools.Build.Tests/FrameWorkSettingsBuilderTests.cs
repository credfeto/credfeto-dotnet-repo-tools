...
public sealed class FrameWorkSettingsBuilderTests : TestBase
{
    ...
    {
        DotNetVersionSettings repo = new(
            SdkVersion: repoSdkVersion,
            AllowPreRelease: repoAllowPreRelease,
            RollForward: repoRollForward
        );
        DotNetVersionSettings template = new(
            SdkVersion: templateSdkVersion,
            AllowPreRelease: templateAllowPreRelease,
            RollForward: templateRollForward
        );
        IFrameworkSettings settings = FrameWorkSettingsBuilder.DefineFrameworkSettings(
            repositoryDotNetSettings: repo,
            templateDotNetSettings: template
        );
