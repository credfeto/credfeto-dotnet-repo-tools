...
internal static partial class SinglePackageUpdaterLoggingExtensions
{
    ...
    public static partial void LogBuildFailedAfterPackageUpdate(this ILogger<SinglePackageUpdater> logger, Exception exception);

    [LoggerMessage(EventId = 11, Level = LogLevel.Information, Message = "Resetting {clonePath} to {branch}")]
    private static partial void LogResettingToDefault(this ILogger<SinglePackageUpdater> logger, string clonePath, string branch);
    ...
    private static partial void LogSkippingPackageCommit(this ILogger<SinglePackageUpdater> logger, string clonePath, string packageId, string version, string branch);

    public static void LogSkippingPackageCommit(this ILogger<SinglePackageUpdater> logger, in RepoContext repoContext, string branch, string packageId, string version)
    {
    ...
    private static partial void LogCommittingPackageToBranch(this ILogger<SinglePackageUpdater> logger, string clonePath, string packageId, string version, string branch);

    public static void LogCommittingToDefault(this ILogger<SinglePackageUpdater> logger, in RepoContext repoContext, string packageId, string version)
    {
    ...
    public static void LogCommittingToNamedBranch(this ILogger<SinglePackageUpdater> logger, in RepoContext repoContext, string branch, string packageId, string version)
    {
