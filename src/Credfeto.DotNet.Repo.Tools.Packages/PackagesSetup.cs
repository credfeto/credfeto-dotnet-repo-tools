...
public static class PackagesSetup
{
    ...
    {
        return services.AddSingleton<IBulkPackageUpdater, BulkPackageUpdater>().AddSingleton<IBulkPackageConfigLoader, BulkPackageConfigLoader>().AddBulkPackageConfigLoaderHttpClient();
    }
