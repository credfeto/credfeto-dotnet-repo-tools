...
public static class ReleaseConfigExtensions
{
    ...
    public static bool CheckRepoForAllowedAutoUpgrade(in this ReleaseConfig releaseConfig, string repoClonePath)
    {
        return releaseConfig.ShouldAlwaysCreatePatchRelease(repoClonePath)
            || releaseConfig.AllowedAutoUpgrade.MatchesPolicy(repoClonePath: repoClonePath, policy: true);
    }
    ...
    public static bool ShouldAlwaysReleasePublishable(in this ReleaseConfig releaseConfig, string repoClonePath)
    {
