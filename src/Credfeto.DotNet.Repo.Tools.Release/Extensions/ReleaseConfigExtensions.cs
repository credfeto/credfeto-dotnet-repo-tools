...
public static class ReleaseConfigExtensions
{
    ...
    {
        return releaseConfig.NeverRelease.MatchesPolicy(repoClonePath: repoClonePath, policy: false);
    }
    ...
    {
        return releaseConfig.ShouldAlwaysCreatePatchRelease(repoClonePath) || releaseConfig.AllowedAutoUpgrade.MatchesPolicy(repoClonePath: repoClonePath, policy: true);
    }
    ...
    {
        return !releaseConfig.ShouldNeverAutoReleaseRepo(repoClonePath) && releaseConfig.AlwaysMatch.MatchesPolicy(repoClonePath: repoClonePath, policy: false);
    }
