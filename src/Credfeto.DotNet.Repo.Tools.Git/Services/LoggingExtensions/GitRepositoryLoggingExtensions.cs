...
internal static partial class GitRepositoryLoggingExtensions
{
    ...
    [LoggerMessage(
        ...
        Message = "Pushed {canonicalName} to {upstream} ({branchName})"
    )]
    public static partial void LogPushedBranchUpstream(
        this ILogger logger,
    ...
    public static partial void RemoveBranchesForPrefixMatchedSkipPrefix(
        this ILogger logger,
        string branch,
        string upstream,
        string branchPrefix,
    ...
    [LoggerMessage(
        EventId = 10,
        Level = LogLevel.Warning,
        Message = "* [RemoveBranchesForPrefix] Matched (Skip) Current Branch for update exact {branch} (branchPrefix: [{upstream}/]{branchPrefix}, branchForUpdate: [{upstream}/]{branchForUpdate})"
    )]
    public static partial void RemoveBranchesForPrefixMatchedExactSkip(
        this ILogger logger,
        string branch,
        string upstream,
        string branchPrefix,
    ...
    public static partial void RemoveBranchesForPrefixMatchedAlternate(
        this ILogger logger,
        string branch,
        string upstream,
        string branchPrefix,
    ...
    public static partial void RemoveBranchesForPrefixNoMatch(
        this ILogger logger,
        string branch,
        string upstream,
        string branchPrefix,
