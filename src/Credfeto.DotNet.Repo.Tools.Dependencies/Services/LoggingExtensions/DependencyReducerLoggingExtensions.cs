...
internal static partial class DependencyReducerLoggingExtensions
{
    ...
    [LoggerMessage(EventId = 3, Level = LogLevel.Information, Message = "({projectInstance}/{projectCount}): Starting project testing: {project}")]
    ...
    [LoggerMessage(EventId = 4, Level = LogLevel.Information, Message = "({projectInstance}/{projectCount}): Completed project testing: {project}")]
    public static partial void FinishTestingProject(this ILogger<DependencyReducer> logger, int projectInstance, int projectCount, string project);
    ...
    [LoggerMessage(EventId = 7, Level = LogLevel.Information, Message = "* Building {project} using {minimalSdk} instead of {currentSdk}...")]
    ...
    [LoggerMessage(EventId = 9, Level = LogLevel.Information, Message = "= Skipping {packageId} as it is marked as do not remove")]
    ...
    [LoggerMessage(EventId = 11, Level = LogLevel.Information, Message = "= {project} references package {packageId} ({version}) also in child project {childProject}")]
    ...
    [LoggerMessage(EventId = 12, Level = LogLevel.Information, Message = "* Building {project} without package {packageId} ({version})...")]
    ...
    [LoggerMessage(EventId = 14, Level = LogLevel.Information, Message = "= {project} references package {relativeInclude} also in child project {childProject}")]
    ...
    [LoggerMessage(EventId = 15, Level = LogLevel.Information, Message = "* Building {project} without project reference {relativeInclude}...")]
    ...
    [LoggerMessage(EventId = 16, Level = LogLevel.Information, Message = "= {project}: SDK does not need changing. Currently {sdk}.")]
    public static partial void SdkDoesNotNeedChanging(this ILogger<DependencyReducer> logger, string project, string sdk);

    [LoggerMessage(EventId = 17, Level = LogLevel.Information, Message = "Analyse completed in {durationSeconds} seconds")]
    public static partial void AnalyzeCompletedInDuration(this ILogger<DependencyReducer> logger, double durationSeconds);

    [LoggerMessage(EventId = 18, Level = LogLevel.Information, Message = "{count} SDK reference(s) could potentially be narrowed.")]
    public static partial void SdkNarrowReferenceCount(this ILogger<DependencyReducer> logger, long count);

    [LoggerMessage(EventId = 19, Level = LogLevel.Information, Message = "{count} reference(s) could potentially be removed")]
    public static partial void ReferencesCouldBeRemoved(this ILogger<DependencyReducer> logger, long count);

    [LoggerMessage(EventId = 20, Level = LogLevel.Information, Message = "{count} reference(s) could potentially be switched")]
    ...
    [LoggerMessage(EventId = 24, Level = LogLevel.Information, Message = "{project}: check removal of {packageId} ({version})")]
    public static partial void ProjectPackageReference(this ILogger<DependencyReducer> logger, string project, string packageId, string? version);

    [LoggerMessage(EventId = 25, Level = LogLevel.Information, Message = "{project}: check removal of project {referenceProject}")]
    public static partial void ProjectChildProjectReference(this ILogger<DependencyReducer> logger, string project, string referenceProject);
