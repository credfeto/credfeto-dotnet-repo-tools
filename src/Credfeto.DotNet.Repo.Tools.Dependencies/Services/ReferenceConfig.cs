...
public sealed class ReferenceConfig
{
    ...
    public bool IsDoNotRemovePackage(string packageId, IReadOnlyList<string> allPackageIds)
    {
        ...
        {
            return allPackageIds.Any(id =>
                id.StartsWith(value: "Serilog.", comparisonType: StringComparison.OrdinalIgnoreCase)
            );
        }
