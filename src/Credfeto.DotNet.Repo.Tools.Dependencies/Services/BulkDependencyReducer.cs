...
public sealed class BulkDependencyReducer : IBulkDependencyReducer
{
    ...
    public BulkDependencyReducer(ILogger<BulkDependencyReducer> logger)
    {
        this._logger = logger;
    }
                                           ...
                                           CancellationToken cancellationToken)
    {
        ...
        int result = await CheckReferencesAsync(sourceDirectory: workFolder, config: config, cancellationToken: cancellationToken);
    ...
    private static async ValueTask<int> CheckReferencesAsync(string sourceDirectory, ReferenceConfig config, CancellationToken cancellationToken)
    {
