...
internal static partial class SourceFileReformatterLoggingExtensions
{
    ...
    private static partial void FormattingErrorsFound(
        this ILogger<SourceFileReformatter> logger,
        string filename,
        string errors
    );

    public static void FormattingErrorsFound(
        this ILogger<SourceFileReformatter> logger,
        string filename,
    ...
    )
    {
        string msg = string.Join(
            ...
            errors.Select(e => $"{e.Id}: {e.Location}: {e.GetMessage()}")
        );
    ...
    public static partial void FormattingErrorsFound(
        this ILogger<SourceFileReformatter> logger,
        string filename,
        string message,
        Exception exception
