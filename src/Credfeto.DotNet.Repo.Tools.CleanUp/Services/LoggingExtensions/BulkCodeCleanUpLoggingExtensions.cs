...
internal static partial class BulkCodeCleanUpLoggingExtensions
{
    ...
    [LoggerMessage(
        EventId = 20,
        Level = LogLevel.Information,
        Message = "Project Cleanup Starting: {filename}"
    )]
    public static partial void StartingProjectCleaup(
        this ILogger<BulkCodeCleanUp> logger,
        string filename
    );
    ...
    [LoggerMessage(
        EventId = 23,
        Level = LogLevel.Information,
        Message = "Cleaning: {filename} (unchanged)"
    )]
    public static partial void CleaningFileUnchanged(
        this ILogger<BulkCodeCleanUp> logger,
        string filename
    );
    ...
    [LoggerMessage(
        EventId = 24,
        Level = LogLevel.Information,
        Message = "Cleaning: {filename} (introduced changes)"
    )]
    public static partial void CleaningFileDifferent(
        this ILogger<BulkCodeCleanUp> logger,
        string filename
    );
}
