...
- Package/release tracking tools no longer compare a Base64 content hash against a git commit SHA when deciding whether a repository's last known build is still good, so bulk package updates and release generation stop rebuilding every package/repo on every run
### Changed
...
## [1.4.4] - 2025-11-20
### Changed
- Show full time as process can be long running
...
## [1.4.1] - 2025-11-07
### Changed
- Apply pre-release and release codeanalysis rulesets on builds
...
- Dependencies - Updated FunFair.BuildCheck to 474.1.5.1771
...
- Dependencies - Updated Credfeto.Package to 1.10.212.1812
